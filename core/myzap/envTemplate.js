...
function buildEnvContent(params = {}) {
    ...
    return [
        ...
        '# ser rotacionado centralmente). Requer MyZap pack >= v3.0.5 (3.0.3/3.0.4',
        '# tinham o modo agente quebrado: funcao "process" do decisionEngine sombreava',
        '# o global). O toggle "Atendente IA" do painel ClickExpress (campo ia_ativa',
